/**
 * Módulo de base de datos SQLite (via sql.js — WASM, sin deps nativas).
 *
 * Expone helpers síncronos una vez inicializado.
 * La inicialización es async (carga del WASM), por lo que se exporta
 * una promesa que resuelve al objeto db listo.
 */
...
async function initDatabase() {
  ...
  // Índice para agilizar búsquedas por usuario y mes
  _db.run(`
...
module.exports = { initDatabase, run, get, all, save };
